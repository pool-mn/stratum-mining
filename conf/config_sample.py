...
COINDAEMON_ALGO = 'scrypt'    # The available options are:  scrypt, sha256d, scrypt-jane, skeinhash, quark, nist5, xcoin, x13, x15, x14, fresh, x17
...
PERFBAN_ENABLED = False         # Enable/disable temporary banning of high-performance workers
PERFBAN_MAX_SHARES = 5          # Max count requests for good shares per time interval we ban
PERFBAN_INTERVAL = 60           # Size in seconds for time slice
PERFBAN_BAN_TIME = 0            # How long we ban worker by performance (0 - to the end of current interval, 1 - to the end of next interval, etc)

IPBAN_ENABLED = False         # Enable/disable temporary banning of high-performance ip
IPBAN_MAX_SHARES = 5          # Max count requests for good shares per time interval we ban by ip
IPBAN_INTERVAL = 60           # Size in seconds for time slice
IPBAN_BAN_TIME = 0            # How long we ban ip by performance (0 - to the end of current interval, 1 - to the end of next interval, etc)
...
# ******************** Cahrity Settings *********************
CHARITY_ENABLED = False         # True if coin has charity reward
CHARITY_ADDRESS = ''            # Address where to send charity
CHARITY_ISFIRSTTXOUT = False    # True - charity should be fist txout, False - charity should be second txout
CHARITY_ISDAEMONAMOUNT = True   # True - use charity amount received from daemon, False - use CHARITY_AMOUNT
CHARITY_AMOUNT = 0              # Charity amount if we do not use value received from daemon
CHARITY_ISCOINBASEINCLUDESCHARITY = False   # True - daemon returns coinbase = miner_reward + charity_value, False - daemon returns coinbase = miner_reward
